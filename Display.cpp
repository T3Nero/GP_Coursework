...
void Display::initDisplay()
{
	...
	sdlWindow = SDL_CreateWindow("Aurora Sunset", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, (int)screenWidth, (int)screenHeight, SDL_WINDOW_OPENGL); // create window
